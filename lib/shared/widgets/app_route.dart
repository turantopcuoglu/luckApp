        ...
        (
          ...
          final Animation<double> gelenOpaklik = CurvedAnimation(
            ...
            curve: const Interval(
              _gelenBaslangicEsigi,
              1,
              curve: Curves.easeOut,
            ),
          );
          final Animation<double> gelenOlcek =
              Tween<double>(begin: _gelenBaslangicOlcegi, end: 1).animate(
                CurvedAnimation(parent: animasyon, curve: Curves.easeOutCubic),
              );
          final Animation<double> gidenOpaklik = Tween<double>(begin: 1, end: 0)
              .animate(
                CurvedAnimation(
                  parent: ikincil,
                  curve: const Interval(
